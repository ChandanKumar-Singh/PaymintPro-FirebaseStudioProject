  ...
  return (
    <div>
      <div className="mb-10">
        ...
        <h1 className="text-5xl font-bold tracking-tight text-gray-900">Cookie Policy</h1>
        <p className="mt-2 text-gray-500">Last updated: {new Date().toLocaleDateString('en-US', { year: 'numeric', month: 'long', day: 'numeric' })}</p>
      ...
      <article className="space-y-4 text-gray-700 leading-relaxed prose prose-neutral max-w-none">
        ...
        <h2 className="text-2xl font-bold text-gray-800 pt-4">2. Why do we use cookies?</h2>
        ...
        <h2 className="text-2xl font-bold text-gray-800 pt-4">3. Types of cookies we use</h2>
        <ul>
        ...
        <h2 className="text-2xl font-bold text-gray-800 pt-4">4. How can I control cookies?</h2>
        ...
        <Card>
            ...
            <CardContent className="space-y-6">
                <div className="space-y-2 p-4 border rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">These cookies are essential for you to browse the website and use its features, such as accessing secure areas of the site. They cannot be disabled.</p>
                </div>
                <div className="space-y-2 p-4 border rounded-lg">
                    <div className="flex items-center justify-between">
                    ...
                    <p className="text-sm text-gray-600">These cookies are used to enhance the performance and functionality of our website but are non-essential to their use. However, without these cookies, certain functionality may become unavailable.</p>
                </div>
                <div className="space-y-2 p-4 border rounded-lg">
                    <div className="flex items-center justify-between">
                ...
                <div className="space-y-2 p-4 border rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">These cookies are used to make advertising messages more relevant to you and your interests. They perform functions like preventing the same ad from continuously reappearing.</p>
                </div>
            </CardContent>

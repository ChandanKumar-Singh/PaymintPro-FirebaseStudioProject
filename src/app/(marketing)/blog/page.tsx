    ...
    return (
        <main className="bg-white text-[#052011]">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        {featuredPosts.map((post, index) => (
                            <Link href="#" key={index} className="group">
                                <Card className="overflow-hidden rounded-2xl shadow-sm hover:shadow-lg transition-shadow duration-300 border-gray-200">
                                    <CardContent className="p-0">
                                        ...
                                        <div className="p-6">
                                            ...
                                            <h2 className="text-2xl font-bold mb-3 group-hover:text-lime-600 transition-colors">{post.title}</h2>
            ...
            <section className="py-12 sm:py-20 bg-[#F9FAFB]">
                <div className="container mx-auto px-4">
                    <h2 className="text-4xl font-bold mb-8 text-center">Customer stories</h2>
                    <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8">
                        {stories.map((story, index) => (
                           <Link key={index} href="#" className={`group ${index === 0 ? 'lg:col-span-2' : 'lg:col-span-1'}`}>
                            <Card className={`rounded-2xl shadow-sm hover:shadow-lg transition-shadow duration-300 h-full flex flex-col ${story.bgColor} ${story.textColor}`}>
                                <CardContent className="p-8 flex-grow flex flex-col">
                                    ...
                                    <div className="flex justify-between items-end mt-6">
                                        ...
                                        <Image src={story.image} alt="" width={index === 0 ? 120 : 100} height={index === 0 ? 120 : 100} data-ai-hint={story.dataAiHint} className="rounded-full" />
                                    </div>
                                </CardContent>
                            </Card>
                           </Link>
